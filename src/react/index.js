const ReactComponentAnalyzer = require('./componentAnalyzer');
const ReactComponentComparator = require('./componentComparator');

class ReactDuplicateDetector {
  constructor(options = {}) {
          ...
          if (similarity >= 0.8) { // Configurable threshold
            duplicates.push({
              ...
              details: {
                ...
                styles: this.comparator.compareStyles(comp1.component.styles, comp2.component.styles),
                hooks: this.comparator.compareHooks(comp1.component.hooks, comp2.component.hooks),
                methods: this.comparator.compareMethods(comp1.component.methods, comp2.component.methods)
              }
            });
          }
        }
...
module.exports = ReactDuplicateDetector;
